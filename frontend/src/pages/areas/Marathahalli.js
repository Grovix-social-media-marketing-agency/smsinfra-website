...
const WHATSAPP =
  "https://wa.me/917676590045?text=Hi%20I%20need%20a%20quote%20for%20Marathahalli";
...
const SERVICES = [
  {
    ...
    short: "RMC",
    desc: "M20 to M40 grade concrete delivered fresh via our own transit mixers — for slabs, columns, and foundations across Marathahalli and the Outer Ring Road corridor.",
  ...
  },
  {
    ...
    desc: "ISI-certified M Sand for concrete and P Sand for plastering. Bulk delivery to all localities within the Marathahalli zone.",
    tag: "ISI Certified",
  },
  {
    num: "03",
    ...
    short: "4″ · 6″ · 8″",
    desc: "Consistent quality solid blocks for load-bearing walls, partitions, and compound walls — available in bulk for residential and commercial projects in Marathahalli.",
    tag: "Bulk available",
  },
  {
    num: "04",
    ...
    short: "6mm – 40mm",
    desc: "Coarse and fine aggregates for structural, road, and drainage works. We supply 6mm, 10mm, 20mm, and 40mm grades directly to sites in Marathahalli.",
    tag: "All grades",
  },
  {
    num: "05",
    ...
    short: "JCBs & Tippers",
    desc: "Site clearing, soil excavation, levelling, and material transport with our own fleet of JCBs, excavators, and tipper trucks across Marathahalli.",
    tag: "Own fleet",
  },
  {
    num: "06",
    ...
    short: "End-to-End",
    desc: "Road work, drainage, building foundations, and commercial development — complete supply and execution support across the Marathahalli and ORR corridor.",
    tag: "Full support",
  },
];
...
const REASONS = [
  {
    label: "ORR Corridor Coverage",
    body: "Marathahalli sits on Bengaluru's Outer Ring Road — one of the city's most active construction zones. Our fleet is optimised to navigate and serve this corridor efficiently.",
  },
  {
  ...
  },
  {
    ...
    body: "Every batch of M Sand, P Sand, RMC, and aggregates is quality-tested. We supply to tech campuses, residential complexes, and commercial projects in Marathahalli.",
  },
  {
    label: "30+ Years in Bangalore",
    body: "Decades of supply experience across Bengaluru's key construction corridors means fewer surprises and more reliable service throughout your project.",
  },
  {
...
const FAQS = [
  {
    q: "Do you deliver along the Outer Ring Road in Marathahalli?",
    a: "Yes — we cover all areas in and around Marathahalli including the ORR corridor, Kadubeesanahalli, Iblur, Doddanekundi, and surrounding localities.",
  },
  {
  ...
  {
    q: "How quickly can M Sand reach my Marathahalli site?",
    a: "Same-day or next-day delivery for orders placed before 12 noon, subject to availability. We prioritise sites within the Marathahalli zone.",
  },
  {
    q: "Can you supply materials for large commercial projects in Marathahalli?",
    a: "Absolutely. We regularly supply RMC, aggregates, M Sand, and blocks for large residential complexes and commercial developments along the ORR.",
  },
  {
...
/* ── Component ──────────────────────────────────────────── */
export default function Marathahalli() {
  ...
  return (
    <div className="ec-page">
      <Helmet>
        <title>
          Construction Material Supplier in Marathahalli Bangalore | SMS Infra
        </title>
        <meta
          name="description"
          content="SMS Infra supplies RMC, M Sand, P Sand, solid blocks, aggregates, and earthmoving services in Marathahalli Bangalore. Same-day delivery. Call +91 76765 90045."
        />
        <link
          rel="canonical"
          href="https://www.smsinfra.com/construction-services-marathahalli"
        />
      </Helmet>
      ...
      <section className="ec-hero" ref={heroRef}>
        ...
        >
          ...
          >
            ...
            Serving Marathahalli · Bengaluru
          </motion.div>
          ...
          <div className="ec-hero-headline">
            ...
            >
              ...
              <br />
              Delivered to{" "}
              <strong className="ec-hero-strong">Marathahalli</strong>
            </motion.h1>
          </div>
          ...
          <motion.p
            ...
            custom={2}
          >
            SMS Infra — serving Marathahalli's fast-growing residential and commercial
            projects. Ready Mix Concrete, M Sand, P Sand, solid blocks, and aggregates
          ...
          <motion.div
            ...
            custom={3}
          >
            <span className="ec-chip">📍 Marathahalli, Bengaluru</span>
        ...
        <div className="ec-container ec-coverage-inner">
          ...
          >
            ...
            <p className="ec-coverage-sub">
              ...
              surrounding the Marathahalli zone, Bengaluru.
            </p>
            <button
