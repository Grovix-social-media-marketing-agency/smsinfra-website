...
const WHATSAPP =
  "https://wa.me/917676590045?text=Hi%20I%20need%20a%20quote%20for%20Whitefield";
...
const SERVICES = [
  {
    ...
    short: "RMC",
    desc: "M20 to M40 grade concrete delivered fresh via our own transit mixers — for slabs, columns, and foundations across Whitefield and the ITPL corridor.",
  ...
  },
  {
    ...
    desc: "ISI-certified M Sand for concrete and P Sand for plastering. Bulk delivery to all localities within the Whitefield zone.",
    tag: "ISI Certified",
  },
  {
    num: "03",
    ...
    short: "4″ · 6″ · 8″",
    desc: "Consistent quality solid blocks for load-bearing walls, partitions, and compound walls — available in bulk for residential and commercial projects in Whitefield.",
    tag: "Bulk available",
  },
  {
    num: "04",
    ...
    short: "6mm – 40mm",
    desc: "Coarse and fine aggregates for structural, road, and drainage works. We supply 6mm, 10mm, 20mm, and 40mm grades directly to sites in Whitefield.",
    tag: "All grades",
  },
  {
    num: "05",
    ...
    short: "JCBs & Tippers",
    desc: "Site clearing, soil excavation, levelling, and material transport with our own fleet of JCBs, excavators, and tipper trucks across Whitefield.",
    tag: "Own fleet",
  },
  {
    num: "06",
    ...
    short: "End-to-End",
    desc: "Road work, drainage, building foundations, and IT campus site development — complete supply and execution support across Whitefield and the ITPL corridor.",
    tag: "Full support",
  },
];
...
const REASONS = [
  {
    label: "Reliable Supply for Large Projects",
    body: "Whitefield hosts some of Bengaluru's largest IT campuses and residential townships. Our fleet and capacity are built to handle high-volume, consistent supply requirements.",
  },
  {
  ...
  },
  {
    ...
    body: "Every batch of M Sand, P Sand, RMC, and aggregates is quality-tested. We supply to IT parks, apartment complexes, and infrastructure projects in Whitefield.",
  },
  {
...
const FAQS = [
  {
    q: "Do you deliver to ITPL and Hoodi in Whitefield?",
    a: "Yes — we cover all areas within the Whitefield zone including ITPL, Hoodi, Kadugodi, Varthur, Brookefield, and Mahadevapura.",
  },
  {
  ...
  {
    q: "How quickly can M Sand reach my Whitefield site?",
    a: "Same-day or next-day delivery for orders placed before 12 noon, subject to availability. We prioritise sites within the Whitefield corridor.",
  },
  {
    q: "Can you supply materials for IT campus construction in Whitefield?",
    a: "Absolutely. We have experience supplying RMC, aggregates, M Sand, and blocks for large-scale IT parks, warehouses, and commercial developments.",
  },
  {
...
export default function Whitefield() {
  ...
  return (
    <div className="ec-page">
      <Helmet>
        <title>
          Construction Material Supplier in Whitefield Bangalore | SMS Infra
        </title>
        <meta
          name="description"
          content="SMS Infra supplies RMC, M Sand, P Sand, solid blocks, aggregates, and earthmoving services in Whitefield Bangalore. Same-day delivery. Call +91 76765 90045."
        />
        <link
          rel="canonical"
          href="https://www.smsinfra.com/construction-services-whitefield"
        />
      </Helmet>
        ...
        >
          ...
          <div className="ec-hero-headline">
            ...
            >
              ...
              <br />
              Delivered to{" "}
              <strong className="ec-hero-strong">Whitefield</strong>
            </motion.h1>
          </div>
          ...
          <motion.p
            ...
            custom={2}
          >
            SMS Infra — supplying Whitefield's IT parks, townships, and residential projects.
            Ready Mix Concrete, M Sand, P Sand, solid blocks, and aggregates delivered on time,
            every time.
          </motion.p>
          ...
          <motion.div
            ...
            custom={3}
          >
            <span className="ec-chip">📍 Whitefield, Bengaluru</span>
        ...
        <div className="ec-container ec-coverage-inner">
          ...
          >
            ...
            <p className="ec-coverage-sub">
              ...
              surrounding the Whitefield zone, Bengaluru.
            </p>
            <button
