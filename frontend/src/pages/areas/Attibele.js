...
const WHATSAPP =
  "https://wa.me/917676590045?text=Hi%20I%20need%20a%20quote%20for%20Attibele";
...
const SERVICES = [
  {
    ...
    short: "RMC",
    desc: "M20 to M40 grade concrete delivered fresh via our own transit mixers — for slabs, columns, and foundations across Attibele and the Hosur Road industrial corridor.",
  ...
  },
  {
    ...
    desc: "ISI-certified M Sand for concrete and P Sand for plastering. Bulk delivery to all localities and industrial zones in and around Attibele.",
    tag: "ISI Certified",
  },
  {
    num: "03",
    ...
    short: "4″ · 6″ · 8″",
    desc: "Consistent quality solid blocks for load-bearing walls, partitions, and compound walls — available in bulk for residential and industrial projects in Attibele.",
    tag: "Bulk available",
  },
  {
    num: "04",
    ...
    short: "6mm – 40mm",
    desc: "Coarse and fine aggregates for structural, road, and drainage works. We supply 6mm, 10mm, 20mm, and 40mm grades directly to sites in Attibele.",
    tag: "All grades",
  },
  {
    num: "05",
    ...
    short: "JCBs & Tippers",
    desc: "Site clearing, soil excavation, levelling, and material transport with our own fleet of JCBs, excavators, and tipper trucks across Attibele.",
    tag: "Own fleet",
  },
  {
    num: "06",
    ...
    short: "End-to-End",
    desc: "Road work, drainage, industrial foundations, and warehousing site development — complete supply and execution support across Attibele and Hosur Road.",
    tag: "Full support",
  },
];
...
const REASONS = [
  {
    label: "Closest Supplier on Hosur Road",
    body: "Our Chandapura base sits just a few kilometres from Attibele — the shortest supply chain on the Hosur Road corridor means faster delivery and fresher RMC.",
  },
  {
  ...
  },
  {
    ...
    body: "Every batch of M Sand, P Sand, RMC, and aggregates is quality-tested. We supply to industrial warehouses, factories, and residential projects in Attibele.",
  },
  {
    label: "30+ Years on the Hosur Road Corridor",
    body: "Decades of supply experience along the Hosur Road and Anekal corridor means fewer surprises and more reliable service throughout your project.",
  },
  {
    label: "Transparent Pricing",
    body: "No hidden charges. Bulk orders for large projects and industrial sites get preferential rates and priority delivery scheduling.",
  },
  {
...
const FAQS = [
  {
    q: "Do you deliver to Attibele Industrial Area?",
    a: "Yes — we cover Attibele Town, Attibele Industrial Area, Marsur, Jigani, Anekal, and all surrounding localities along Hosur Road.",
  },
  {
  ...
  {
    q: "How quickly can M Sand reach my Attibele site?",
    a: "Same-day or next-day delivery for orders placed before 12 noon. Our Chandapura base is just a few kilometres away, so Attibele gets some of the fastest turnaround times.",
  },
  {
    q: "Can you supply materials for industrial and warehouse construction in Attibele?",
    a: "Absolutely. We have extensive experience supplying RMC, aggregates, M Sand, and blocks for large industrial buildings, warehouses, and factories in Attibele.",
  },
  {
...
/* ── Component ──────────────────────────────────────────── */
export default function Attibele() {
  ...
  return (
    <div className="ec-page">
      <Helmet>
        <title>
          Construction Material Supplier in Attibele Bangalore | SMS Infra
        </title>
        <meta
          name="description"
          content="SMS Infra supplies RMC, M Sand, P Sand, solid blocks, aggregates, and earthmoving services in Attibele Bangalore. Same-day delivery. Call +91 76765 90045."
        />
        <link
          rel="canonical"
          href="https://www.smsinfra.com/construction-services-attibele"
        />
      </Helmet>
        ...
        >
          ...
          <div className="ec-hero-headline">
            ...
            >
              ...
              <br />
              Delivered to{" "}
              <strong className="ec-hero-strong">Attibele</strong>
            </motion.h1>
          </div>
          ...
          <motion.p
            ...
            custom={2}
          >
            SMS Infra — based in Chandapura, just minutes from Attibele. We supply
            Ready Mix Concrete, M Sand, P Sand, solid blocks, and aggregates for
            industrial and residential sites on time, every time.
          </motion.p>
          ...
          <motion.div
            ...
            custom={3}
          >
            <span className="ec-chip">📍 Attibele, Anekal Taluk</span>
        ...
        <div className="ec-container ec-coverage-inner">
          ...
          >
            ...
            <p className="ec-coverage-sub">
              ...
              surrounding Attibele, Anekal Taluk, Bengaluru.
            </p>
            <button
