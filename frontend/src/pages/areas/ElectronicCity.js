...
const WHATSAPP =
  "https://wa.me/917676590045?text=Hi%20I%20need%20a%20quote%20for%20Electronic%20City";
...
const SERVICES = [
  {
    ...
    short: "RMC",
    desc: "M20 to M40 grade concrete delivered fresh via our own transit mixers — for slabs, columns, and foundations across Electronic City Phase 1 & 2.",
  ...
  },
  {
    ...
    desc: "ISI-certified M Sand for concrete and P Sand for plastering. Bulk delivery to all localities within the Electronic City corridor.",
    tag: "ISI Certified",
  },
  {
    num: "03",
    ...
    short: "4″ · 6″ · 8″",
    desc: "Consistent quality solid blocks for load-bearing walls, partitions, and compound walls — available in bulk for residential and commercial projects.",
    tag: "Bulk available",
  },
  {
    num: "04",
    ...
    short: "6mm – 40mm",
    desc: "Coarse and fine aggregates for structural, road, and drainage works. We supply 6mm, 10mm, 20mm, and 40mm grades directly to site.",
    tag: "All grades",
  },
  {
    num: "05",
    ...
    short: "JCBs & Tippers",
    desc: "Site clearing, soil excavation, levelling, and material transport with our own fleet of JCBs, excavators, and tipper trucks.",
    tag: "Own fleet",
  },
  {
    num: "06",
    ...
    short: "End-to-End",
    desc: "Road work, drainage, building foundations, and industrial site development — complete supply and execution support across the EC corridor.",
    tag: "Full support",
  },
];
...
const REASONS = [
  {
    ...
    body: "Our Chandapura base sits just 12 km from Electronic City — shorter distance means fresher RMC, faster turnaround, and lower transport cost.",
  },
  {
  ...
  },
  {
    ...
    body: "Every batch of M Sand, P Sand, RMC, and aggregates is quality-tested. We supply to IT campuses, apartment complexes, and infrastructure projects.",
  },
  {
    label: "30+ Years in South Bangalore",
    body: "Decades of supply experience across the Hosur Road corridor means fewer surprises and more reliable service throughout your project.",
  },
  {
...
const FAQS = [
  {
    q: "Do you deliver to Electronic City Phase 2?",
    a: "Yes — both Phase 1 and Phase 2, plus Hosur Road, Bommasandra, and all surrounding areas within the Electronic City zone.",
  },
  {
  ...
  {
    q: "How quickly can M Sand reach my site?",
    a: "Same-day or next-day delivery for orders placed before 12 noon, subject to availability. We prioritise sites within the EC corridor.",
  },
  {
    q: "Can you handle large apartment projects?",
    a: "Absolutely. We regularly supply RMC, aggregates, M Sand, and blocks for large residential complexes and commercial developments.",
  },
  {
...
/* ── Component ──────────────────────────────────────────── */
export default function ElectronicCity() {
  ...
  return (
    <div className="ec-page">
      <Helmet>
        <title>
          Construction Material Supplier in Electronic City Bangalore | SMS Infra
        </title>
        <meta
          name="description"
          content="SMS Infra supplies RMC, M Sand, P Sand, solid blocks, aggregates, and earthmoving services in Electronic City Bangalore. Same-day delivery. Call +91 76765 90045."
        />
        <link
          rel="canonical"
          href="https://www.smsinfra.com/construction-services-electronic-city"
        />
      </Helmet>
      ...
      <section className="ec-hero" ref={heroRef}>
        ...
        >
          ...
          >
            ...
            Serving Electronic City · Bengaluru
          </motion.div>
          ...
          <div className="ec-hero-headline">
            ...
            >
              ...
              <br />
              Delivered to{" "}
              <strong className="ec-hero-strong">Electronic City</strong>
            </motion.h1>
          </div>
          ...
          <motion.p
            ...
            custom={2}
          >
            SMS Infra — based in Chandapura, just 12 km from your site. We deliver
          ...
          <motion.div
            ...
            custom={3}
          >
            <span className="ec-chip">📍 Pincode 560100</span>
      ...
      <section className="ec-section ec-services">
        <div className="ec-container">
          ...
          >
            ...
            <h2 className="ec-h2">
              Everything your Electronic City
              <br />
      ...
      {/* ══ WHY US — alternating split layout ════════════ */}
      <section className="ec-section ec-why">
        <div className="ec-container">
          ...
          >
            ...
            <h2 className="ec-h2">
              Builders across Electronic City
              <br />
              trust SMS Infra.
            </h2>
          </motion.div>
        ...
        <div className="ec-container ec-coverage-inner">
          ...
          >
            ...
            <p className="ec-coverage-sub">
              ...
              surrounding the Electronic City zone, Bengaluru.
            </p>
            <button
