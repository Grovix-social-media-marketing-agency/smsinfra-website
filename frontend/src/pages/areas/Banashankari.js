...
const WHATSAPP =
  "https://wa.me/917676590045?text=Hi%20I%20need%20a%20quote%20for%20Banashankari";
...
const SERVICES = [
  {
    ...
    short: "RMC",
    desc: "M20 to M40 grade concrete delivered fresh via our own transit mixers — for slabs, columns, and foundations across Banashankari and the Kanakapura Road corridor.",
  ...
  },
  {
    ...
    desc: "ISI-certified M Sand for concrete and P Sand for plastering. Bulk delivery to all stages and localities within Banashankari.",
    tag: "ISI Certified",
  },
  {
    num: "03",
    ...
    short: "4″ · 6″ · 8″",
    desc: "Consistent quality solid blocks for load-bearing walls, partitions, and compound walls — available in bulk for residential and commercial projects in Banashankari.",
    tag: "Bulk available",
  },
  {
    num: "04",
    ...
    short: "6mm – 40mm",
    desc: "Coarse and fine aggregates for structural, road, and drainage works. We supply 6mm, 10mm, 20mm, and 40mm grades directly to sites in Banashankari.",
    tag: "All grades",
  },
  {
    num: "05",
    ...
    short: "JCBs & Tippers",
    desc: "Site clearing, soil excavation, levelling, and material transport with our own fleet of JCBs, excavators, and tipper trucks across Banashankari.",
    tag: "Own fleet",
  },
  {
    num: "06",
    ...
    short: "End-to-End",
    desc: "Road work, drainage, building foundations, and residential development — complete supply and execution support across Banashankari and Kanakapura Road.",
    tag: "Full support",
  },
];
...
const REASONS = [
  {
    label: "Well-Connected to South Bangalore",
    body: "Banashankari is one of South Bangalore's most established residential corridors. Our Chandapura base connects here efficiently, ensuring timely delivery of materials.",
  },
  {
  ...
  },
  {
    ...
    body: "Every batch of M Sand, P Sand, RMC, and aggregates is quality-tested. We supply to independent houses, apartment complexes, and commercial projects in Banashankari.",
  },
  {
    label: "30+ Years in South Bangalore",
    body: "Decades of supply experience across South Bangalore's residential corridors means fewer surprises and more reliable service throughout your project.",
  },
  {
...
const FAQS = [
  {
    q: "Do you deliver to all stages of Banashankari?",
    a: "Yes — we cover all stages of Banashankari (Stage 1 through 5), Kanakapura Road, Uttarahalli, Katriguppe, and surrounding areas.",
  },
  {
  ...
  {
    q: "How quickly can M Sand reach my Banashankari site?",
    a: "Same-day or next-day delivery for orders placed before 12 noon, subject to availability. We prioritise sites within Banashankari.",
  },
  {
    q: "Can you handle individual house construction in Banashankari?",
    a: "Absolutely. We supply RMC, M Sand, blocks, and aggregates for individual house constructions as well as large apartment projects in Banashankari.",
  },
  {
...
/* ── Component ──────────────────────────────────────────── */
export default function Banashankari() {
  ...
  return (
    <div className="ec-page">
      <Helmet>
        <title>
          Construction Material Supplier in Banashankari Bangalore | SMS Infra
        </title>
        <meta
          name="description"
          content="SMS Infra supplies RMC, M Sand, P Sand, solid blocks, aggregates, and earthmoving services in Banashankari Bangalore. Same-day delivery. Call +91 76765 90045."
        />
        <link
          rel="canonical"
          href="https://www.smsinfra.com/construction-services-banashankari"
        />
      </Helmet>
      ...
      <section className="ec-hero" ref={heroRef}>
        ...
        >
          ...
          >
            ...
            Serving Banashankari · Bengaluru
          </motion.div>
          ...
          <div className="ec-hero-headline">
            ...
            >
              ...
              <br />
              Delivered to{" "}
              <strong className="ec-hero-strong">Banashankari</strong>
            </motion.h1>
          </div>
          ...
          <motion.p
            ...
            custom={2}
          >
            SMS Infra — trusted supplier for Banashankari's homes, apartments, and
            commercial sites. Ready Mix Concrete, M Sand, P Sand, solid blocks, and
            aggregates delivered on time, every time.
          </motion.p>
          ...
          <motion.div
            ...
            custom={3}
          >
            <span className="ec-chip">📍 Banashankari, Bengaluru</span>
        ...
        <div className="ec-container ec-coverage-inner">
          ...
          >
            ...
            <p className="ec-coverage-sub">
              We deliver construction materials to all stages and localities within
              and surrounding Banashankari, Bengaluru.
            </p>
            <button
