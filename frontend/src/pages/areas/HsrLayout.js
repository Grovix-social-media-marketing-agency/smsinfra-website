...
const WHATSAPP =
  "https://wa.me/917676590045?text=Hi%20I%20need%20a%20quote%20for%20HSR%20Layout";
...
const SERVICES = [
  {
    ...
    short: "RMC",
    desc: "M20 to M40 grade concrete delivered fresh via our own transit mixers — for slabs, columns, and foundations across HSR Layout and surrounding areas.",
  ...
  },
  {
    ...
    desc: "ISI-certified M Sand for concrete and P Sand for plastering. Bulk delivery to all sectors and localities within HSR Layout.",
    tag: "ISI Certified",
  },
  {
    num: "03",
    ...
    short: "4″ · 6″ · 8″",
    desc: "Consistent quality solid blocks for load-bearing walls, partitions, and compound walls — available in bulk for residential and commercial projects in HSR Layout.",
    tag: "Bulk available",
  },
  {
    num: "04",
    ...
    short: "6mm – 40mm",
    desc: "Coarse and fine aggregates for structural, road, and drainage works. We supply 6mm, 10mm, 20mm, and 40mm grades directly to sites in HSR Layout.",
    tag: "All grades",
  },
  {
    num: "05",
    ...
    short: "JCBs & Tippers",
    desc: "Site clearing, soil excavation, levelling, and material transport with our own fleet of JCBs, excavators, and tipper trucks across HSR Layout.",
    tag: "Own fleet",
  },
  {
    num: "06",
    ...
    short: "End-to-End",
    desc: "Road work, drainage, building foundations, and commercial site development — complete supply and execution support across HSR Layout.",
    tag: "Full support",
  },
];
...
const REASONS = [
  {
    ...
    body: "Our Chandapura base connects directly to HSR Layout via Hosur Road — ensuring timely delivery of RMC and materials before they lose workability.",
  },
  {
  ...
  },
  {
    ...
    body: "Every batch of M Sand, P Sand, RMC, and aggregates is quality-tested. We supply to premium residential complexes and commercial buildings in HSR Layout.",
  },
  {
...
const FAQS = [
  {
    q: "Do you deliver to all sectors in HSR Layout?",
    a: "Yes — we cover all sectors of HSR Layout, including Sector 1 through 7, Agara, and surrounding areas.",
  },
  {
  ...
  {
    q: "How quickly can M Sand reach my HSR Layout site?",
    a: "Same-day or next-day delivery for orders placed before 12 noon, subject to availability. We prioritise sites within HSR Layout.",
  },
  {
    q: "Can you handle large commercial projects in HSR Layout?",
    a: "Absolutely. We regularly supply RMC, aggregates, M Sand, and blocks for large residential complexes and commercial developments in HSR Layout.",
  },
  {
...
export default function HSRLayout() {
  ...
  return (
    <div className="ec-page">
      <Helmet>
        <title>
          Construction Material Supplier in HSR Layout Bangalore | SMS Infra
        </title>
        <meta
          name="description"
          content="SMS Infra supplies RMC, M Sand, P Sand, solid blocks, aggregates, and earthmoving services in HSR Layout Bangalore. Same-day delivery. Call +91 76765 90045."
        />
        <link
          rel="canonical"
          href="https://www.smsinfra.com/construction-services-hsr-layout"
        />
      </Helmet>
        ...
        >
          ...
          <div className="ec-hero-headline">
            ...
            >
              ...
              <br />
              Delivered to{" "}
              <strong className="ec-hero-strong">HSR Layout</strong>
            </motion.h1>
          </div>
          ...
          <motion.p
            ...
            custom={2}
          >
            SMS Infra — based in Chandapura, connected via Hosur Road to HSR Layout. We deliver
          ...
          <motion.div
            ...
            custom={3}
          >
            <span className="ec-chip">📍 HSR Layout, Bengaluru</span>
        ...
        <div className="ec-container ec-coverage-inner">
          ...
          >
            ...
            <p className="ec-coverage-sub">
              We deliver construction materials to all sectors and localities within
              and surrounding HSR Layout, Bengaluru.
            </p>
            <button
